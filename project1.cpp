...
#define PASS_CODE "A1708" // Generic password
using namespace std;
...
int main()
{
    ...
    Client clients[5];
    // Consider these are the clients that have registered
    ...
    // Consider that the bookings for the clients are as shown below
    Booking bookings[5];
    ...
    cout << endl;
    for (int i = 0; i < 5; i++) // 5 iterations because there are 5 clients
    {
        ...
        {
            cout << "Name or password is incorrect.";
            break;
        }
    }
    return 0;
